 ...
 * - Model routing (Haiku default, Sonnet for quality-critical, Opus for research-grade)
...
const MODELS = {
  ...
  // Opus (Tier 3): used for research-grade multi-agent tasks where quality > latency
  opus: {
    id: 'claude-opus-4-6',
...
const TASK_MODEL_MAP = {
  ...
  // Agent tasks — Haiku for fast, non-critical nodes
  'agent_critic': 'haiku',
  'linkedin_message_draft': 'haiku',
  ...
  'proof_demo': 'sonnet',
  'recategorize': 'sonnet',
  // Agent tasks — Sonnet for quality nodes
  'agent_copywriter': 'sonnet',
  'agent_optimizer': 'sonnet',
  'video_script': 'sonnet',
  // Advisor insights (many per user, cost-sensitive)
  'advisor_insight': 'haiku',
  'benchmark_analysis': 'haiku',

  // Opus tasks (research-grade, quality > cost)
  'agent_research': 'opus'
};
